      ...
      /*  String uploadPath = getServletContext().getRealPath("")
        ...
        */
        ...
        String u=UUID.randomUUID().toString();
                        ...
                        String f_name = filePath.replaceAll("\\\\", "&&");
                         
                         String query=obj1.insertIntoDocuments(u, d, fileName, user, f_name);
                        // out.println(f_name);
                          obj2.result(query);
        ...
        getServletContext().getRequestDispatcher("/viewDocument.jsp").forward(
               request, response);
    }
